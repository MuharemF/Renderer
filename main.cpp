...
//the following helps create the sphere using the formula x^2+y^2+z^2=r^2
//however using a more simplifed version we used the h=b/(-2)=d*(C-Q) formula to display the circle
...
color ray_color(const ray& r) {
    auto t=hitSphere(point3(0,0,-1),.5,r);
    if (t>0.0) {
